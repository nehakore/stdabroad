...
<jsp:include page="../common/header.jsp">
    <jsp:param name="title" value="Company Registration - Study & Jobs Abroad" />
</jsp:include>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-10 col-lg-12" data-aos="fade-up">
            ...
            <div id="successMessage" class="alert alert-success d-none text-center p-5 rounded-4 shadow-sm mb-4 bg-white border-0">
                ...
                <p class="fs-5 text-gray-600 mb-2">Your registration has been submitted. Our operations team will verify your documents.</p>
                <p class="text-muted mb-4" style="font-size:0.9rem;">You will receive an email once your account is approved.</p>
                <a href="/jobprovider/login" class="btn btn-primary btn-lg rounded-pill px-5" style="background:linear-gradient(135deg,#3b82f6,#6366f1);border:none;">
            ...
            <c:if test="${param.error == 'emailExists'}">
                <div class="alert alert-danger text-center shadow-sm rounded-3 mb-4 border-0 p-3">
                    ...
                    <span class="align-middle">This email address is already registered. Please <a href="/jobprovider/login" class="fw-bold alert-link">Login here</a> or use a different email.</span>
                </div>
            </c:if>
                ...
                <div class="row g-0 h-100">
                    ...
                    <div class="col-lg-4 bg-gradient-primary text-white p-5 d-none d-lg-flex flex-column justify-content-center">
                        <div class="left-panel-content text-center">
                            <i class="fas fa-building mb-4 text-white" style="font-size: 4rem;"></i>
                            <h2 class="fw-bold mb-4">Partner With Us</h2>
                            <p class="text-white-50 mb-5">Join our global network of top employers and recruiters.</p>
                            ...
                            <div class="d-flex align-items-center text-start">
                                <i class="fas fa-check-circle text-info fs-5 me-3"></i>
                                <span>Hire international students</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-step" id="step2">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="agencyName" name="organizationName" class="form-control" placeholder="E.g. Tech Global Inc." required>
